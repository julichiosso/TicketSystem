  ...
  <div class="fixed bottom-6 right-6 z-[100] flex flex-col gap-3 pointer-events-none">
    ...
    >
      <div 
        ...
        :key="notification.id"
        class="pointer-events-auto flex items-center gap-3 px-6 py-4 rounded-2xl shadow-2xl border backdrop-blur-xl min-w-[320px] max-w-md animate-in slide-in-from-right-10 duration-300"
        :class="[
      ...
      >
        ...
        <button 
          ...
          class="flex-shrink-0 p-1 hover:bg-white/5 rounded-lg transition-colors"
        >
